...
public class DashBoard extends JFrame implements ActionListener{
	...
	int d,pa,to;
	public DashBoard() {
		//setIconImage(Toolkit.getDefaultToolkit().getImage(DashBoard.class.getResource("     ImageIcon")));
	//ImageIcon("C:/Users/Digambar/eclipse-workspace/practics/img/back.jpg");
		...
		//ImageIcon ii=new ImageIcon(getClass().getResource("/practice/img/back.jpg"));
		//ImageIcon ii=new ImageIcon(getClass().getResource("C:/Users/Digambar/eclipse-workspace/practics/img/back.jpg"));
